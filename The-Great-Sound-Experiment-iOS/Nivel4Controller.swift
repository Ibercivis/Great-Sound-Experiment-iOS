...
class Nivel4Controller: UIViewController {
            ...
            if (readyVotar == false){
                ...
                if (numeroPartidas == 1) {
                    if (resultadoFinal == 1) {
                        ...
                        gameRequest(elnivel: 4, acierto: 1)
                    }
                    else {
                        gameRequest(elnivel: 4, acierto: 0)
                ...
                if (numeroPartidas == 3) {
                    if (resultadoFinal == 1) {
                        gameRequest(elnivel: 4, acierto: 1)
                        let storyBoard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
                        let newViewController = storyBoard.instantiateViewController(withIdentifier: "Nivel5")
                        self.present(newViewController, animated: true, completion: nil)
            ...
            if (readyVotar == false){
                ...
                if (numeroPartidas == 3) {
                    if (resultadoFinal == 2) {
                        ...
                        let newViewController = storyBoard.instantiateViewController(withIdentifier: "Nivel5")
                        self.present(newViewController, animated: true, completion: nil)
                        self.toastMessage("You're right! Last level!")
