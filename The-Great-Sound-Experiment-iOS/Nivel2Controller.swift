...
class Nivel2Controller: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        resultado1 = generarPares(elnivel: 2)
    ...
    func play1(){
        ...
        if(sonando2 == true){
            readyVotar = true
            respuestaAudio1.isEnabled = true
            respuestaAudio2.isEnabled = true
        }
            ...
            if (readyVotar == false){
                ...
                if (numeroPartidas == 1) {
                    if (resultadoFinal == 1) {
                        ...
                        gameRequest(elnivel: 2, acierto: 1)
                    }
                    else {
                        gameRequest(elnivel: 2, acierto: 0)
                ...
                if (numeroPartidas == 3) {
                    if (resultadoFinal == 1) {
                        ...
                        let storyBoard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
                        let newViewController = storyBoard.instantiateViewController(withIdentifier: "Nivel3")
                        self.present(newViewController, animated: true, completion: nil)
